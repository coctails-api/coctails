...
public class UserService {
    ...
    public void generateNewEmailPassword(User user){
        ...
        tokenService.save(confirmationTokenEntity);
        sendEmailPassword(confirmationTokenEntity, user);
    }
    ...
    public void sendEmailPassword(ConfirmationTokenEntity confirmationTokenEntity, User user){
        String link = "http://localhost:4200/user/generateNewPassword?token=" + confirmationTokenEntity.getToken();
        emailSender.send(user.getEmail(), buildEmailNewPassword(user.getEmail(),link));
    }
...
//            return "Czas na potwierdzenie minal. Sprobuj ponownie";
    ...
    private String buildEmailNewPassword(String name, String link) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                "\n" +
                "<span style=\"display:none;font-size:1px;color:#fff;max-height:0\"></span>\n" +
                "\n" +
